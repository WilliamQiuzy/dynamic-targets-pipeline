...
class Sam3BasePredictor:
    ...
    def handle_request(self, request):
        ...
        if request_type == "start_session":
            ...
            return self.add_prompt(
                ...
                _skip_reset=request.get("_skip_reset", False),
            )
    ...
    def add_prompt(
        ...
        ``_skip_reset``: ROSE pipeline patch — propagated to the multiplex
        ``add_prompt`` so multi-anchor batched bbox init can preserve prior
        prompts (skip the reset_state call).
        """
